...
export default class PostingConcept {
  ...
  async create(author: ObjectId, translation: string, imageUrl?: string, audioUrl?: string) {
    const _id = await this.posts.createOne({ author, translation, imageUrl, audioUrl });
